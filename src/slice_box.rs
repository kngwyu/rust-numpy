...
use pyo3::pyclass::{PyClass, PyClassAlloc, PyClassInitializer, PyClassShell};
use pyo3::pyclass_slots::PyClassDummySlot;
use pyo3::{ffi, type_object, types::PyAny, PyResult, Python};
...
impl<T> SliceBox<T> {
    pub(crate) unsafe fn new(
        ...
        let init = PyClassInitializer::from_value(value);
        init.create_shell(py)
    }
}
